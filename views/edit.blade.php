    ...
    <div class="panel panel-default">
        ...
        <form method="POST" action="/slider/{{$slider->id}}" enctype="multipart/form-data" id="multiple_upload_form">
            ...
            <div class="panel-body">
                ...
                <input type="date" name="oldSlides[{{$imageKey}}][start_date]" class="form-control"
                 value="{{ date('Y-m-d', strtotime($slide->start_date)) }}">
                
                <label class="color-black">End Date</label>
                <input type="date" name="oldSlides[{{$imageKey}}][end_date]" class="form-control" 
                value="{{ date('Y-m-d', strtotime($slide->end_date)) }}">
